...
This repository contains the implementation of a small-scale evaluation of an autonomous underwater vehicle (AUV) with the mission to find and inspect a pipeline located on a seabed which was inspired by the exemplar [SUAVE](https://arxiv.org/abs/2303.09220v1).
